...
class TestMerkleTree(TestCase):
    ...
    def test_merkle_tree_pairs_even(self):
        assert [(0, 1), (2, 3)] == blockchain.MerkleTree.pairs([0, 1, 2, 3])

    def test_merkle_tree_pairs_odd(self):
        assert [(0, 1), (2, 3), (4, 4)] == blockchain.MerkleTree.pairs([0, 1, 2, 3, 4])

    def test_merkle_tree_pairs_single(self):
        assert [(0, 0)] == blockchain.MerkleTree.pairs([0])

    def test_merkle_tree_pairs_empty(self):
        assert [] == blockchain.MerkleTree.pairs([])
